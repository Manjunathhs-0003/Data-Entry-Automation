...
# Use Zillow-Clone website (instead of Zillow.com)
...
#ist of all the addresses on the page using a CSS Selector
...
for n in range(len(all_links)):
    ...
    #xpath to select the "short answer" fields in your Google Form. 
